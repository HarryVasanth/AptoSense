    ...
    builderUDP.setPositiveButton(
      ...
      new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
          ...
          txtDIP.setText(
            String.valueOf(ipAddress) + ":" + String.valueOf(UDP_SERVER_PORT)
          );
        }
      }
    );
    builderUDP.setNegativeButton(
      "Cancel",
      new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
